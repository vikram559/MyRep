...
public class GuestCancellation_AfterHost_Accepts {
	    WebDriver driver;
...
//		   
		   ...
		   Guest2.assertEquals(ResStatus, "Cancelled");
	  ...
	  public void HostLoginToAccept() throws InterruptedException{
	   ...
	   public void HostLogOut() throws InterruptedException{
		   ...
		   wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='nav-user-avatar']/img"))).click();
	      //  Thread.sleep(4000);
	        //driver.findElement(By.xpath("//div[@class='nav-user-avatar']/img")).click();
	        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//a[@class='top-links-link']/b"))).click();;
	        //driver.findElement(By.xpath("//a[@class='top-links-link' and @href='/auth/logout']")).click();
	        Thread.sleep(4000);
	        driver.get("http://ec2-52-35-179-203.us-west-2.compute.amazonaws.com");
		  
	  }
	  @Test(priority=8)
  	public void GuestLoginToCancel() throws InterruptedException{
	    	//SignIn
			WebElement SignIn = driver.findElement(By.xpath("//button[text()='Sign In']"));
			SignIn.click();
			...
			Guest2.assertEquals(Status, "Cancelled");
